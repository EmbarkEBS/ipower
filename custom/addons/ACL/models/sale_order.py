...
#                 raise UserError(
#                     "No vendor found on products. Please assign vendor to products."
#                 )
...
# Vendor Payment Terms
        if vendor.property_supplier_payment_term_id:
            po_vals['payment_term_id'] = vendor.property_supplier_payment_term_id.id

        # Vendor Incoterm (from your screenshot)
        if vendor.x_studio_incoterm:
            po_vals['incoterm_id'] = vendor.x_studio_incoterm.id
